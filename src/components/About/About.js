    ...
    <Container fluid className="about-section">
      ...
      <Container>
        <Row className="justify-content-center" style={{ padding: "20px 10px" }}>
          <Col xs={12} md={10} lg={8} style={{ textAlign: "center", padding: "30px 15px" }}>
            ...
            <p style={{ fontSize: "1.1em", lineHeight: "1.8", color: "white" }}>
              ...
              design and development. As a Front-End Developer, 
              Full Stack Developer, and 
              UI/UX Designer, I enjoy crafting 
              clean, user-friendly interfaces using React.js, 
               Node.js, and modern web technologies. 
              I’m also deeply interested in Project Management, 
              where I love planning, organizing, and leading projects from concept to completion.
            </p>
          </Col>
        </Row>
